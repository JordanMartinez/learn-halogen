...
childComponent :: H.Component HH.HTML ChildQuery ChildInput ChildMessage Aff
childComponent =
    H.mkComponent
      { initialState
      , render
  ...
  where
    ...
    renderSectionHeader :: String -> H.ComponentHTML ChildAction () Aff
    ...
    handleAction :: ChildAction
                 -> H.HalogenM ChildState ChildAction () ChildMessage Aff Unit
...
type StateActionQueryInputMessageChildComponentSpec =
  ...
  , receive :: ChildInput -> Maybe ChildAction
  , render :: ChildState -> H.ComponentHTML ChildAction () Aff
  , handleAction :: ChildAction -> H.HalogenM ChildState ChildAction () ChildMessage Aff Unit
  , handleQuery :: forall a. ChildQuery a -> H.HalogenM ChildState ChildAction () ChildMessage Aff (Maybe a)
  }
